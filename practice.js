...
console.log(MakePerson("Tami", "March 11", "345-67-8910"));
...
console.log(MakeCard("4345-4956-3231-3456", "02/19", "198"));
...
function bindCard(person, creditcard) {
  ...
  for (var prop in person) {
    personWithCard[prop] = person[prop];
  }

  for (var prop in creditcard) {
    personWithCard[prop] = creditcard[prop];
  }
